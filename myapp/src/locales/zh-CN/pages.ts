export default {
  'pages.layouts.userLayout.title': 'lxy',
  ...
  'pages.login.username.placeholder': '账户名',
  'pages.register.username.placeholder': '请输入账户名',

  'pages.login.username.required': '用户名是必填项！',
  'pages.login.password.placeholder': '密码',
  'pages.register.password.placeholder': '请重复密码',
